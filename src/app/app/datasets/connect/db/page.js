        ...
        <div className="max-w-4xl mx-auto space-y-8 animation-fade-in">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-[var(--muted-foreground)] text-lg">Directly sync tables from your external DB</p>
                </div>
                    ...
                    <form onSubmit={handleTestConnection} className="space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className={`p-4 rounded-xl border flex items-center space-x-3 transition-all ${dbType === 'postgres' ? 'bg-primary/5 border-primary shadow-sm' : 'border-[var(--border)] hover:bg-[var(--muted)]'}`}
                            >
                            ...
                            <button
                                ...
                                className={`p-4 rounded-xl border flex items-center space-x-3 transition-all ${dbType === 'mysql' ? 'bg-primary/5 border-primary shadow-sm' : 'border-[var(--border)] hover:bg-[var(--muted)]'}`}
                            >
                ...
                <div className="space-y-6">
                    <Card className="p-4 bg-green-50 border-green-100 flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="font-bold text-green-800">Connection Successful!</span>
                        </div>
                    ...
                    <div className="sticky bottom-8">
                        <Button className="w-full py-8 text-xl shadow-2xl" disabled={selectedTables.length === 0 || importing} onClick={handleImport}>
                            {importing ? (
